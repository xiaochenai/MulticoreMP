...
public class GCM_ENCRYPT 
{
	...
	public long filesplit = 0;
	public long fileenc=0;
	public long file_enc_split = 0;
	public long index_enc_split = 0;
	public long indexEnc=0;
	public long indexSplit=0;
	...
	public void gcmEncrypt(String input, byte[] inputKey)
	{
	    ...
	    try 
	    {
	    	...
	    	fileenc = System.currentTimeMillis()-encstart;
	    ...
	    MpSplitFiles.splitFile(_FileEnc, directory);
	    filesplit = System.currentTimeMillis() - fileSplitStart;
	    System.out.println("File splited");
	    //deletes the .encrypted version of the input file
	    deleteFile(_FileEnc);
	    file_enc_split = System.currentTimeMillis()-start;
	}
	...
	public void indexEncrypt(byte[] keyin,String secret)
	{
		...
		try 
		{
			...
			bindingstart = System.currentTimeMillis();
		...
		Keybinding = System.currentTimeMillis() - bindingstart;
		...
		try 
	       {
			if(new File("Index.index").exists())
			{
				...
				long indexEncStart = System.currentTimeMillis();
				encrypter.encrypt(getBytesFromFile(new File("Index.index")),"Index.encrypted");
				indexEnc = System.currentTimeMillis() - indexEncStart;
			}
	       }catch (IOException e){ e.printStackTrace();
	       }
		//deletes the plaintext index file
	    deleteFile("Index.index");
	    index_enc_split = System.currentTimeMillis() - start;
	}
