...
public class GenRandTable {
	...
	private byte[][] RNDArray = new byte[36][32];
	/*******************
	 * note:if RNDArray.txt exist load this file, if not create a new RNDArray
	 * @throws IOException
	 */
	public GenRandTable() throws IOException{
	...
	/*************
	 * 
	 * note:Generate original RNDArray(32 bytes * 36,the sequence in the table), used in MutLen()
	 * @return Random Sequence Array, the original Array, then is mutated length in MutLen()
	 */
	public byte[][] GeneRandSeqArray(){
		byte[][] HashArray = new byte[36][32];
	...
	public String[] GetMutLenRandString(){
		byte[][] a = GeneRandSeqArray();
		byte[][] newa = MutLen(a);
		String[] MutStringArray = new String[36];
...
//		}
		...
		ave1=ave2=ave3=0;
		byte[][] a =s.GeneRandSeqArray();;
		byte[][] newa = s.MutLen(a);
//		for(int i=0;i<50;i++){
//			start1 = System.nanoTime();
//			 a =s.GeneRandSeqArray();
...
//		}
		...
		for(int index=0;index<a.length;index++){
			...
			System.out.println("NEW String : " + pp[index]);
